...
(function dartProgram() {
  ...
  H = {JS_CONST: function JS_CONST() {
    ...
    diagnoseIndexError: function(indexable, index) {
      ...
      $length = H._asIntS(t1.get$length(indexable));
      if (!(index < 0)) {
        ...
        t2 = true;
      if (t2) {
        t1 = H._asIntS($length == null ? t1.get$length(indexable) : $length);
  ...
  J = {
    ...
    JSArray_JSArray$fixed: function($length, $E) {
      if ($length < 0 || $length > 4294967295)
        throw H.wrapException(new P.RangeError(0, 4294967295, true, $length, "length", "Invalid value"));
  ...
  D = {
    main: function() {
      var t2, t3,
        t1 = type$.legacy_CanvasElement._as(document.querySelector("#canvas"));
      $.canvas = t1;
      $.context = type$.legacy_CanvasRenderingContext2D._as((t1 && C.CanvasElement_methods).getContext$1(t1, "2d"));
      D.drawCell(new P.Point(10, 10, type$.Point_legacy_num), "salmon");
      t1 = new D.Game();
      t2 = $.canvas;
      t3 = t2.width;
      if (typeof t3 !== "number")
        return t3.$tdiv();
      t1._rightEdgeX = C.JSInt_methods._tdivFast$1(t3, 10);
      t2 = t2.height;
      if (typeof t2 !== "number")
        return t2.$tdiv();
      t1._bottomEdgeY = C.JSInt_methods._tdivFast$1(t2, 10);
      t1._snake = D.Snake$();
      t1.set$_food(t1._randomPoint$0());
      t1.run$0();
    },
    drawCell: function(coords, color) {
      var x, y,
        t1 = $.context;
      (t1 && C.CanvasRenderingContext2D_methods).set$fillStyle(t1, color);
      C.CanvasRenderingContext2D_methods.set$strokeStyle(t1, "white");
      x = coords.x * 10;
      y = coords.y * 10;
      t1 = $.context;
      t1.fillRect(x, y, 10, 10);
      t1.strokeRect(x, y, 10, 10);
    },
    Keyboard$: function() {
      var t1 = new D.Keyboard(P.HashMap_HashMap(type$.legacy_int, type$.legacy_num));
      t1.Keyboard$0();
      return t1;
    },
    Snake$: function() {
      var t1 = new D.Snake(C.Point_1_0);
      t1.Snake$0({});
      return t1;
    },
    ...
    Keyboard__closure: function Keyboard__closure(t0) {
      this.event = t0;
    },
    Keyboard_closure0: function Keyboard_closure0(t0) {
      this.$this = t0;
    },
    Snake: function Snake(t0) {
      this._body = null;
      this._dir = t0;
    },
    Snake_closure: function Snake_closure(t0) {
      this._box_0 = t0;
    },
    Game: function Game() {
      var _ = this;
      _._lastTimeStamp = 0;
      _._food = _._snake = _._bottomEdgeY = _._rightEdgeX = null;
    }
  };
  var holders = [C, H, J, P, W, D];
  ...
  W.CanvasRenderingContext2D.prototype = {
    ...
    set$strokeStyle: function(receiver, value) {
  ...
  W.Window.prototype = {
    get$animationFrame: function(receiver) {
      ...
      t2.toString;
      this._requestAnimationFrame$1(receiver, t2);
      return t1;
    },
  ...
  D.Keyboard.prototype = {
    Keyboard$0: function() {
      var t4,
        t1 = window,
        t2 = type$.nullable_void_Function_legacy_KeyboardEvent,
        t3 = t2._as(new D.Keyboard_closure(this));
      type$.nullable_void_Function._as(null);
      t4 = type$.legacy_KeyboardEvent;
      W._EventStreamSubscription$(t1, "keydown", t3, false, t4);
      W._EventStreamSubscription$(window, "keyup", t2._as(new D.Keyboard_closure0(this)), false, t4);
    }
  };
  D.Keyboard_closure.prototype = {
    call$1: function($event) {
      type$.legacy_KeyboardEvent._as($event);
      this.$this._keys.putIfAbsent$2($event.keyCode, new D.Keyboard__closure($event));
    },
    $signature: 4
  };
  D.Keyboard__closure.prototype = {
    call$0: function() {
  ...
  D.Keyboard_closure0.prototype = {
    call$1: function($event) {
      this.$this._keys.remove$1(0, type$.legacy_KeyboardEvent._as($event).keyCode);
    },
    $signature: 4
  };
  D.Snake.prototype = {
    Snake$0: function(_box_0) {
      _box_0.i = 5;
      this.set$_body(0, P.List_List$generate(6, new D.Snake_closure(_box_0), type$.legacy_Point_num));
    },
    grow$0: function() {
      var t4, t5,
        t1 = this._body,
        t2 = (t1 && C.JSArray_methods).get$first(t1),
        t3 = this._dir;
      t2.toString;
      t4 = t2.$ti;
      t4._as(t3);
      t5 = t4._precomputed1;
      t4 = H._arrayInstanceType(t1)._precomputed1._as(new P.Point(t5._as(t2.x + t3.x), t5._as(t2.y + t3.y), t4));
      if (!!t1.fixed$length)
    ...
    _draw$0: function() {
      ...
      for (t1 = this._body, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i)
        D.drawCell(t1[_i], "green");
    },
    set$_body: function(_, _body) {
      this._body = type$.legacy_List_legacy_Point_num._as(_body);
    },
    set$_dir: function(_dir) {
      this._dir = type$.legacy_Point_num._as(_dir);
    }
  };
  D.Snake_closure.prototype = {
    call$1: function(index) {
      return new P.Point(this._box_0.i--, 0, type$.Point_legacy_num);
    },
    $signature: 18
  };
  D.Game.prototype = {
    _randomPoint$0: function() {
      return new P.Point(C.C__JSRandom.nextInt$1(this._rightEdgeX), C.C__JSRandom.nextInt$1(this._bottomEdgeY), type$.Point_legacy_num);
    },
    run$0: function() {
      var $async$goto = 0,
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              ...
              t1 = $async$temp1._asNumS($async$result);
              ...
              if (t1 - t2 > 50) {
                ...
                t1 = $.context;
                (t1 && C.CanvasRenderingContext2D_methods).set$fillStyle(t1, "white");
                t2 = $.canvas;
                t1.fillRect(0, 0, t2.width, t2.height);
                D.drawCell($async$self._food, "blue");
                t2 = $async$self._snake;
                t2.toString;
                if ($.$get$keyboard()._keys.containsKey$1(37) && !t2._dir.$eq(0, C.Point_1_0))
                  t2.set$_dir(C.Point_m1_0);
                else if ($.$get$keyboard()._keys.containsKey$1(39) && !t2._dir.$eq(0, C.Point_m1_0))
                  t2.set$_dir(C.Point_1_0);
                else if ($.$get$keyboard()._keys.containsKey$1(38) && !t2._dir.$eq(0, C.Point_0_1))
                  t2.set$_dir(C.Point_0_m1);
                else if ($.$get$keyboard()._keys.containsKey$1(40) && !t2._dir.$eq(0, C.Point_0_m1))
                  t2.set$_dir(C.Point_0_1);
                t2.grow$0();
                t1 = t2._body;
                (t1 && C.JSArray_methods).removeLast$0(t1);
                t2._draw$0();
                t1 = $async$self._snake._body;
                if (J.$eq$((t1 && C.JSArray_methods).get$first(t1), $async$self._food)) {
                  $async$self._snake.grow$0();
                  $async$self.set$_food($async$self._randomPoint$0());
                }
                t1 = $async$self._snake._body;
                if ((t1 && C.JSArray_methods).get$first(t1).x > -1) {
                  t1 = $async$self._snake._body;
                  if ((t1 && C.JSArray_methods).get$first(t1).x < $async$self._rightEdgeX) {
                    t1 = $async$self._snake._body;
                    if ((t1 && C.JSArray_methods).get$first(t1).y > -1) {
                      t1 = $async$self._snake._body;
                      t1 = (t1 && C.JSArray_methods).get$first(t1).y >= $async$self._bottomEdgeY;
                    } else
                      t1 = true;
                  } else
                    t1 = true;
    ...
    set$_food: function(_food) {
      this._food = type$.legacy_Point_num._as(_food);
    }
  };
  (function aliases() {
  ...
  var init = {
    ...
    metadata: [],
    types: ["Null()", "~()", "~(~())", "Null(@)", "Null(KeyboardEvent*)", "@(@)", "@(@,String)", "@(String)", "Null(~())", "~(@)", "Null(@,StackTrace)", "Null(int,@)", "Null(Object,StackTrace)", "_Future<@>(@)", "Null(Object?,Object?)", "Null(num)", "@(Event)", "num*()", "Point<num*>*(int*)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: typeof Symbol == "function" && typeof Symbol() == "symbol" ? Symbol("$ti") : "$ti"
  };
  H._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"JavaScriptObject","UnknownJavaScriptObject":"JavaScriptObject","JavaScriptFunction":"JavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","AElement":"Element","GraphicsElement":"Element","SvgElement":"Element","AudioElement":"HtmlElement","MediaElement":"HtmlElement","CompositionEvent":"UIEvent","HtmlDocument":"Node","Document":"Node","JSBool":{"bool":[]},"JSNull":{"Null":[]},"JavaScriptObject":{"Function":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[]},"JSDouble":{"num":[]},"JSString":{"String":[]},"EfficientLengthIterable":{"Iterable":["1"]},"NullError":{"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"RuntimeError":{"Error":[]},"_AssertionError":{"Error":[]},"_Error":{"Error":[]},"_TypeError":{"Error":[]},"_SyncCompleter":{"_Completer":["1"]},"_Future":{"Future":["1"]},"AsyncError":{"Error":[]},"_Zone":{"Zone":[]},"_RootZone":{"_Zone":[],"Zone":[]},"_HashMap":{"MapMixin":["1","2"],"HashMap":["1","2"]},"_HashMapKeyIterable":{"Iterable":["1"]},"MapBase":{"MapMixin":["1","2"]},"int":{"num":[]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"NullThrownError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"StateError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"StackOverflowError":{"Error":[]},"CyclicInitializationError":{"Error":[]},"_StringStackTrace":{"StackTrace":[]},"HtmlElement":{"EventTarget":[]},"AnchorElement":{"EventTarget":[]},"AreaElement":{"EventTarget":[]},"CanvasElement":{"EventTarget":[]},"Element":{"EventTarget":[]},"FormElement":{"EventTarget":[]},"KeyboardEvent":{"Event":[]},"Node":{"EventTarget":[]},"SelectElement":{"EventTarget":[]},"UIEvent":{"Event":[]},"Window":{"EventTarget":[]},"_EventStream":{"Stream":["1"]},"_EventStreamSubscription":{"StreamSubscription":["1"]}}'));
  H._Universe_addErasedTypes(init.typeUniverse, JSON.parse('{"EfficientLengthIterable":1,"MapBase":2,"Iterable":1}'));
  0;
  var type$ = (function rtii() {
    ...
    return {
      ...
      Point_legacy_num: findType("Point<num*>"),
      ...
      legacy_List_legacy_Point_num: findType("List<Point<num>*>*"),
      legacy_Never: findType("0&*"),
      legacy_Object: findType("Object*"),
      legacy_Point_num: findType("Point<num>*"),
...
;
    ...
    C.Point_0_1 = new P.Point(0, 1, type$.Point_legacy_num);
    C.Point_0_m1 = new P.Point(0, -1, type$.Point_legacy_num);
    C.Point_1_0 = new P.Point(1, 0, type$.Point_legacy_num);
    C.Point_m1_0 = new P.Point(-1, 0, type$.Point_legacy_num);
  })();
  ...
  (function lazyInitializers() {
    ...
    _lazyOld($, "keyboard", "$get$keyboard", function() {
      return D.Keyboard$();
    });
  })();
